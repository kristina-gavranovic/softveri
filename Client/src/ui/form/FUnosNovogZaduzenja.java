 ...
 * @author krist
 */
public class FUnosNovogZaduzenja extends javax.swing.JDialog {

    Radnik ulogovaniRdanik;
    Knjiga knjiga;

    /**
     * Creates new form FUnosNovogZaduzenja
     */
    public FUnosNovogZaduzenja(java.awt.Frame parent, boolean modal, Radnik ulogovaniRadnik, Knjiga knjiga) {
        super(parent, modal);
        initComponents();
...
//            java.util.logging.Logger.getLogger(FUnosNovogZaduzenja.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                FUnosNovogZaduzenja dialog = new FUnosNovogZaduzenja(new javax.swing.JFrame());
